...
public class NewAssetBundleEditor : Editor {
	...
	static void BuildAllAssetBundles ()
	{
        ...
        BuildPipeline.BuildAssetBundles(AssetBundleConfig.ASSETBUNDLE_PATH.Substring(AssetBundleConfig.PROJECT_PATH.Length), BuildAssetBundleOptions.UncompressedAssetBundle |
    ...
    static void SetResourcesAssetBundleName()
    {
        ...
        string[] Filtersuffix = new string[] { ".prefab",".mat",".dds" };   //此处添加需要命名的资源后缀名,注意大小写。
    ...
    static void ClearResourcesAssetBundleName()
    {
        ...
        string[] Filtersuffix = new string[] { ".prefab", ".mat", ".dds" };   //此处添加需要清除的资源后缀名,注意大小写。
